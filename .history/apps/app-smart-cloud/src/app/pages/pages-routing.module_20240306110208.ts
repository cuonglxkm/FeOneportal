...
import { CreateFileSystemSnapshotComponent } from './file-system/create-file-system-snapshot/create-file-system-snapshot.component';
import { FileSystemSnapshotDetailComponent } from './file-system/file-system-snapshot-detail/file-system-snapshot-detai.componentl';
...
const routes: Routes = [
  ...
  {
    path: 'file-system-snapshot/list/create',
