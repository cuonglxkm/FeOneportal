...
import { CreateFileStorageComponent } from "./file-system/create-file-system/create-file-system.component";
...
const routes: Routes = [
  ...
  {
    path:'file-system/create',
    component: CreateFileStorageComponent
  }
  ]
@NgModule({
