...
import { AddDomainRequest, HttpsSettingRequest, SslCertDTO, SslCertRequest, WafDetailDTO, WafDomain, WafDTO, UpdatePolicies, QueryRequesBandwidthtSavingRatioRequestDto, QueryBacktoOriginTrafficAndRequestRequestDto, QueryTrafficRequestInTotalAndPeakValueRequestDto, QueryRequestHitRatioRequestDto, QueryStatusCodeDistributionRequestDto, QueryOriginStatusCodeDistributionRequestDto } from 'src/app/pages/waf/waf.model';
...
export class WafService extends BaseService {
  ...
  queryStatusCodeDistribution(dto: QueryStatusCodeDistributionRequestDto){
    return this.http.post<any>(
      this.baseUrl + this.ENDPOINT.provisions + '/waf/report/status-code',
      dto,
      this.getHeaders()
    );
  }

  queryOriginStatusCodeDistribution(dto: QueryOriginStatusCodeDistributionRequestDto){
    return this.http.post<any>(
      this.baseUrl + this.ENDPOINT.provisions + '/waf/report/status-code/origin',
      dto,
      this.getHeaders()
    );
  }
