...
export const NAME_SPECIAL_REGEX = /^[a-zA-Z0-9_ ][a-zA-Z0-9-_ ]{0,49}$/;
...
export const DOMAIN_REGEX = /^(?![-.])[a-zA-Z0-9-]{1,63}(?:\.[a-zA-Z0-9-]{1,63})*(?<![-.])\.[a-zA-Z]{2,63}$/;
...
export const USERNAME_REGEX = /^[a-zA-Z0-9][a-zA-Z0-9]{0,30}$/;
