...
// Don't define here, just write an example here
...
export class WarehouseManageFormComponent implements OnInit, ControlValueAccessor {
  ...
  checkForm(): boolean {
    // Use the following method to make each item of formArray dirty (if there is formArray, here is just an example)
