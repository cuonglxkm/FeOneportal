...
export class ValidatorsRuleService {
  ...
  mobileRule(value: string): ValidationErrors | null {
    ...
    return isMobile(value) ? null : { message: 'Please enter the correct mobile number' };
  }
  ...
  passwordRule(value: string): ValidationErrors | null {
    ...
    return isPasswordPass(value) ? null : { message: 'The password consists of 6 to 20 uppercase and lowercase letters, numbers or other characters' };
  }
}
