...
import { WindowsWidthService } from '../store/common-store/windows-width.service';
...
export class SubWindowWithService {
  ...
  // Monitor the theme (top or side), and determine the minimum width of the over mode
    ...
    this.themesService
      ...
      .pipe(
        switchMap(res => {
          ...
          // You can enter parameters [Breakpoints.Small, Breakpoints.XSmall]
