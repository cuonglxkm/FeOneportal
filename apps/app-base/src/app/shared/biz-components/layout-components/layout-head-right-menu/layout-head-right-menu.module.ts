...
@NgModule({
  ...
  imports: [LockWidgetModule, DirectivesModule, HomeNoticeModule, SearchRouteModule, ChangePasswordModule, CommonModule, PipesModule, TranslateModule, SHARED_ZORRO_MODULES],
